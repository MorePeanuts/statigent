"""Evaluate Datawise baseline agent on DSBench data modeling tasks."""
...
from statigent.baseline import DatawiseBaselineAgent
...
def main(
    ...
    console.print("[bold]DSBench Datawise Data Modeling Evaluation[/bold]")
    ...
    agent = DatawiseBaselineAgent(model_name=model)
