        ...
        return [
            SystemMessage(
                content=(
                    ...
                    "Preserve the original task information in task_description, "
                    "including material context, questions, constraints, and "
                    "requested details. The objective should be a concise task goal. "
